...
var controller = {
  ...
  playGame: function() {
    controller.snakeInterval = setInterval(function(){
  ...
  checkIfGameOver: function(nextHeadPosition) {
    ...
    if ( (controller.snakeDivs.indexOf(nextHeadPosition) < 0 ) && !controller.checkOutOfBounds(nextHeadPosition) ) {
      return false;
    }
    else {
  ...
  updatePosition: function() {
    ...
    // Add old head position to front of snakebody
